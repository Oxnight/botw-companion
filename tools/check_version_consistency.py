...
DISPLAY_VERSION = "0.40.0-alpha.26"
PEP440_VERSION = "0.40.0a26"
NUMERIC_VERSION = "0.40.0.26"
...
def errors(root: Path, tag: str | None = None) -> list[str]:
    checks = (
        ...
        (root / "windows" / "version_info.txt", rf'filevers=\(0, 40, 0, 26\)', "ressource EXE"),
        ...
        (root / "macos" / "BOTW Companion.spec", r'"CFBundleVersion": "26"', "numéro de build macOS"),
        (
            root / "tools" / "test_macos_installation.sh",
            r'\[\[ "\$ACTUAL_BUNDLE_VERSION" == "26" \]\]',
