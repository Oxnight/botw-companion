...
DISPLAY_VERSION = "0.40.0-alpha.23"
PEP440_VERSION = "0.40.0a23"
NUMERIC_VERSION = "0.40.0.23"
...
def errors(root: Path, tag: str | None = None) -> list[str]:
    checks = (
        ...
        (root / "windows" / "version_info.txt", rf'filevers=\(0, 40, 0, 23\)', "ressource EXE"),
        ...
        (root / "macos" / "BOTW Companion.app" / "Contents" / "MacOS" / "BOTW Companion", re.escape(PEP440_VERSION), "lanceur macOS du clone"),
