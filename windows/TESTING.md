...
Une release est créée uniquement pour le tag exact `v0.40.0-alpha.27` et seulement si les jobs Windows et macOS réussissent. Une validation matérielle sur Windows 10/11 reste recommandée pour les Joy-Con et l’intégration avec les émulateurs.
