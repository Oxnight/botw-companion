...
Les joueurs téléchargent uniquement `BOTW_Companion_0.40.0-alpha.25_Setup.exe` depuis [GitHub Releases](https://github.com/Oxnight/botw-companion/releases). L’installateur x64 embarque le runtime Python, les ressources hors ligne, JoyConDSU et SDL3, puis crée les raccourcis Bureau et menu Démarrer.
...
```text
dist\installer\BOTW_Companion_0.40.0-alpha.25_Setup.exe
```
