...
class WindowsPackageTests(unittest.TestCase):
    ...
    def test_build_script_validates_the_standalone_package(self):
        ...
        self.assertIn('"LICENSE", "CHANGELOG.md", "THIRD_PARTY_NOTICES.md", "DATA_SOURCES.md", "PRIVACY.md", "SECURITY.md"', script)
    ...
    def test_local_build_produces_and_validates_application_and_installer(self):
        ...
        self.assertIn('(Join-Path $InstallRoot "CHANGELOG.md")', validation)
