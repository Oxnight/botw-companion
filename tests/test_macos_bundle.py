...
class MacOSBundleTests(unittest.TestCase):
    ...
    def test_pyinstaller_build_is_windowed_arm64_and_self_contained(self):
        ...
        self.assertIn('"CFBundleVersion": "27"', spec)
        self.assertNotIn('CFBundleShortVersionString": "0.40.0-alpha.27"', spec)
    ...
    def test_dmg_build_and_clean_install_are_exercised(self):
        ...
        self.assertIn("BOTW_Companion_0.40.0-alpha.27_macOS_arm64.dmg", build)
        ...
        self.assertIn('[[ "$ACTUAL_BUNDLE_VERSION" == "27" ]]', validation)
